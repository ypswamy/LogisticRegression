Cars <- read.csv("C:/Users/Pandu/Desktop/Pandu_ course/CASE_STUDY/LR_Car/Cars.csv")
view(Cars)
attach(Cars)
summary(Cars)
dim(Cars)
...
# It is Better to delete influential observations rather than deleting entire # #column which is costliest process Deletion Diagnostics for identifying #influential observations
